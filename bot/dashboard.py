...
.configured-strip {
  ...
  gap: 7px;
  padding: 10px;
  border: 1px solid rgba(73, 209, 124, .24);
  border-radius: 8px;
  background: rgba(73, 209, 124, .06);
}
...
.problem-item {
  grid-template-columns: 74px minmax(0, 1fr) minmax(180px, .34fr);
}
...
.phase-index.good {
  border-color: rgba(73, 209, 124, .34);
  color: var(--green);
}
...
.phase-index.info {
  border-color: rgba(106, 166, 255, .34);
  color: var(--blue);
}
