...
try:
    from .model_fallback import MODEL_FALLBACKS, validate_model, get_fallback_model, check_provider_health, suggest_fallback
    ...
    def get_fallback_model(provider: str, model: str) -> str:
        return model

    def check_provider_health(provider: str) -> bool:
        return True

    def suggest_fallback(provider: str, model: str) -> str:
        return model
