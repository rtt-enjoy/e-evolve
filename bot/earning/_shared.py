...
# Import fallback model functions; provide no‑op defaults if the module is missing.
try:
    ...
    # Provide no‑op defaults so the module can still be imported and used without crashing.
