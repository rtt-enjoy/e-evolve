...
_LOCAL_LEADS = [
    ...
    {
        "title": "AI-powered code documentation generation for developers",
        "url": "",
        "source": "local-playbook",
        "body": "Free LLM tiers (Groq, Gemini, OpenRouter, Cerebras) can generate comprehensive code documentation from source files. Sell per-file or per-module documentation packages to developers who need README files, API docs, and inline comments but lack time. Use free APIs to parse code, generate docs, and output Markdown. Price per 10 files documented.",
        "labels": ["free-ai-api", "code-documentation", "batch-job", "easy-money", "developer-tool"]
    }
]
