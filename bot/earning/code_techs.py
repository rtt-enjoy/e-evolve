...
_LOCAL_LEADS = [
    ...
    {
        "title": "AI-powered SQL query optimization and indexing advice on a free LLM tier",
        "url": "",
        "source": "local-playbook",
        "body": "Free LLM tiers can analyze slow SQL queries and suggest indexes, rewrites, and execution plan improvements. Charge per query analyzed. Developers and DBAs pay for this because manual optimization is time-consuming and error-prone.",
        "labels": ["free-ai-api", "sql", "optimization", "easy-money"]
    }
]
